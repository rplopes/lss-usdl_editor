...
class InteractionsControllerTest < ActionController::TestCase
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post :create, interaction: { comment: @interaction.comment, interaction_type: @interaction.interaction_type, label: @interaction.label, service_system_id: @interaction.service_system_id, sid: @interaction.sid }
    end
  ...
  test "should update interaction" do
    put :update, id: @interaction, interaction: { comment: @interaction.comment, interaction_type: @interaction.interaction_type, label: @interaction.label, service_system_id: @interaction.service_system_id, sid: @interaction.sid }
    assert_redirected_to interaction_path(assigns(:interaction))
  end
